...
commands_search::execute_search() {
    ...
    downloaders_ncbi_search::search_assemblies_by_organism "$ORGANISM" "$OUTPUT_FILE" "$TOP_N" || { log_error "Assembly search failed"; downloaders_common::cleanup_temp; exit 1; }
